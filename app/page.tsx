...
.home-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 16px; margin-top: 36px; }
      ...
      <main className="home-shell">
        <section className="home-main">
          ...
          <p className="home-copy">
            這裡不再掃爆款、不再追 outlier。現在只保留三件事：先定義頻道把尺，將論點放入題目庫，再推上生產線生成 Fern 6-part 劇本。
          </p>
